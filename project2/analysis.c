...
void getLetters(FILE *fileIn, char * charInputIn);
...
int main(int argc, char *argv[])
{
    ...
    else
    {
        ...
        if (readFile)
        {
            ...
            letterOccur = malloc(alphaSize * sizeof(int));
            
            getLetters(readFile, charInput);
...
int getNumWords(char *charInputIn, int fileSizeIn)
{
    ...
    {
        if (charInputIn[i] == ' ' || charInputIn[i] == '\n')
        {
            counter = counter + 1;
        }
    }
